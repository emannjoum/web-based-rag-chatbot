...
from chatbot.domain.exceptions import AppError, AuthError
from chatbot.infrastructure.settings import Settings
from chatbot.presentation.api.routers.auth_router import router as auth_router
...
class ApiApplicationFactory:
    ...
    def _register_exception_handlers(self, app: FastAPI) -> None:
        ...
        async def app_exception_handler(
            ...
            status_code = 401 if isinstance(exc, AuthError) else 500
            return JSONResponse(
